(function(){
    var quotes = [
		  {text:"<q>GIS is waking up the world to the power of geography, this science of integration, and has the framework for creating a better future.</q><br />- Jack Dangermond"},
          {text:"<q>In order to have a decentralized database, you need to have security. In order to have security you need to have incentives.</q><br />- Vitalik Buterin"},
          ...
          {text:"<q>Never send a human to do a machine&#8217;s job.</q><br />- Agent Smith, The Matrix"},
          ...
          {text:"<q>Software is like sex: it&#8217;s better when it&#8217;s free.</q><br />- Linus Torvalds"},
